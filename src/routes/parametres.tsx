      ...
      <Card>
        ...
        <CardContent>
          <div className="flex flex-wrap gap-2">
            ...
            <div className="rounded-md border border-border border-dashed px-3 py-1.5 text-xs flex items-center gap-1.5 text-muted-foreground">
      ...
      <Card>
        ...
        <CardContent className="text-sm space-y-2">
          <div className="flex justify-between">
            ...
            <span className="font-medium">RO Studio</span>
          </div>
          <Separator />
          <div className="flex justify-between">
            <span className="text-muted-foreground">Stack</span>
            <span className="font-medium">React 19 + TanStack Start + Tailwind v4</span>
          </div>
          <Separator />
          <div className="flex justify-between">
            <span className="text-muted-foreground">Déploiement</span>
            <span className="font-medium">Vercel (statique)</span>
          </div>
        </CardContent>
      </Card>
    </div>
